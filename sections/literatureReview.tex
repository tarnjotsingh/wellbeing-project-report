...
to be provided. The API provided, is what will allow the client-side JavaScript application to "plug" into the server as all the main 
business logic will be executed server side.
For web applications, there are two standards for creating an API; SOAP and REST.
